<template>
  <div class="site-wrapper">
    ...
    <site-section title="ایجاد محصول">
      ...
      <div class="body-inner py-3">
        ...
        <v-container>
          ...
          <div class="file-input-wrapper">
            <div class="file-input-inner">
              ...
              <div v-for="(item , key) in product.images" :key="key" class="file-preview">
                <img :src="item">
              </div>
        ...
        <div class="absolute-action-wrapper">
          <div class="absolute-action">
            <button v-if="!loading" class="px-btn size-md px-btn-info block" @click="saveProduct()">ثبت</button>
...
export default {
  ...
  data : () => ({
    ...
    current_selected_picture_type:null,
    loading:false,
    crop_dialog:false,
  }),
  methods: {
    ...
    saveProduct(){
      ...
      this.$axios.post(`store/add-product`,form,
      {
        headers: {
      ...
      .then(res => {
        ...
        this.loading = false
        this.errors = {}
        this.$router.replace({name:'my_shop' , params:{id : this.store_id}})
      })
      .catch(err => {
