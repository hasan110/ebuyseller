...
<template>
  <div class="site-wrapper">
    ...
    <site-section title="ویرایش فروشگاه">
      ...
      <div class="body-inner py-3">
        ...
        <v-container>
          <v-row>
            ...
            >
              <v-file-input
                label="تصویر جدید فروشگاه"
                outlined dense clearable
                v-model="store.new_banner"
        ...
        <div class="absolute-action-wrapper">
          <div class="absolute-action">
            <button v-if="!loading" class="px-btn size-md px-btn-info block" @click="editShop()">ویرایش</button>
            <button v-else class="px-btn size-md px-btn-info disabled block">ویرایش</button>
          </div>
        </div>
